...
export const TaskForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-5 text-center">
      ...
      />
      <p className="mb-3 text-pink-300">
      ...
      <button className="focus: rounded bg-indigo-600 px-3 py-1 text-white outline-none hover:bg-indigo-700">
        {editedTask.taskId === "" ? "Crate" : "Update"}
      </button>
    </form>
  );
};
